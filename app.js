...
client.on('message' , message => {
  if(message.content.startsWith(prefix + 'ajuda')) {
    ...
    .addField("w!cc", "Utilize para limpar o chat atual. (Necessita estar com a tag `wStaff` no servidor desejado")
    .addField("Atenção:", "Há comandos como o w!cc que necessitam da tag `wStaff` para ser utilizado o comando.")
    .setFooter('WiightBOT by wiigevaerd#0202 ')
